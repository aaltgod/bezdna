...
<template>
  <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
    <AppLink :to="{
      name: 'service.settings', params: { name: 'service1' }
    }">
      <!-- Card Item Start -->
      <div
        ...
        <div class="mt-4 flex items-end justify-between">
          <div>
            ...
            <span class="text-sm font-medium">Service 1</span>
          </div>
    ...
    <div
      ...
      <div class="mt-4 flex items-end justify-between">
        <div>
          ...
          <span class="text-sm font-medium">Service 2</span>
        </div>
    ...
    <div
      ...
      <AppLink :to="{ name: 'service.new' }">
        <span>
          <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
            <svg class="fill-primary dark:fill-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
