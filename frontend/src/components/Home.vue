    ...
    <aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
      ...
      <AppLink to="/">
        ...
        <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <h1 class="mb-4 ml-4 text-2xl font-medium box-decoration-slice bg-gradient-to-r from-indigo-600 to-pink-500 text-white px-2 ...">
            ALPHA</h1>
        </div>
        <!-- SIDEBAR HEADER -->
      </AppLink>
          ...
          <div>
            ...
            <ul class="mb-6 flex flex-col gap-1.5">
              ...
              <AppLink :to="{ name: 'services' }">
                <li>
                  <a :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Services') }"
                     class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                     @click="selected = (selected === 'Services' ? '' : 'Services')">
                    <svg class="fill-current" fill="none" height="18" viewBox="0 0 18 18" width="18"
              ...
              <AppLink :to="{ name: 'statistics' }">
                ...
                <li>
                  <a :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Statistics') && (page === 'statistics') }"
                     class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                     @click="selected = (selected === 'Statistics' ? '' : 'Statistics')">
                    <svg class="fill-current" fill="none" height="19" viewBox="0 0 18 19" width="18"
                         xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <clipPath id="clip0_130_9756">
                          <rect fill="white" height="18" transform="translate(0 0.052124)" width="18"/>
                        </clipPath>
                      </defs>
                    </svg>
              ...
              <AppLink :to="{ name: 'settings' }">
                <!-- Menu Item Settings -->
                <li>
                  <a :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Settings') && (page === 'settings') }"
                     class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                ...
                <span class="relative block h-5.5 w-5.5 cursor-pointer">
                  <span class="du-block absolute right-0 h-full w-full">
                    <span
                        ...
                        class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-[0] duration-200 ease-in-out dark:bg-white"></span>
                    <span
                        :class="{ '!w-full delay-400': !sidebarToggle }"
                        class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white"></span>
                    <span
                        :class="{ '!w-full delay-500': !sidebarToggle }"
                        class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white"></span>
                  </span>
                  <span class="du-block absolute right-0 h-full w-full rotate-45">
                    <span
                        :class="{ 'h-0 delay-[0]': !sidebarToggle }"
                        class="absolute left-2.5 top-0 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white"></span>
                    <span
                        :class="{ 'h-0 dealy-200': !sidebarToggle }"
                        class="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white"></span>
                  </span>
                </span>
            </button>
            <!-- Hamburger Toggle BTN -->
            ...
            <form action="https://formbold.com/s/unique_form_id" method="POST">
              <div class="relative">
                <button class="absolute top-1/2 left-0 -translate-y-1/2">
                  <svg class="fill-body hover:fill-primary dark:fill-bodydark dark:hover:fill-primary" fill="none"
                       height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                    <path clip-rule="evenodd" d="M9.16666 3.33332C5.945 3.33332 3.33332 5.945 3.33332 9.16666C3.33332 12.3883 5.945 15 9.16666 15C12.3883 15 15 12.3883 15 9.16666C15 5.945 12.3883 3.33332 9.16666 3.33332ZM1.66666 9.16666C1.66666 5.02452 5.02452 1.66666 9.16666 1.66666C13.3088 1.66666 16.6667 5.02452 16.6667 9.16666C16.6667 13.3088 13.3088 16.6667 9.16666 16.6667C5.02452 16.6667 1.66666 13.3088 1.66666 9.16666Z"
                          fill=""
                          fill-rule="evenodd"/>
                    <path clip-rule="evenodd" d="M13.2857 13.2857C13.6112 12.9603 14.1388 12.9603 14.4642 13.2857L18.0892 16.9107C18.4147 17.2362 18.4147 17.7638 18.0892 18.0892C17.7638 18.4147 17.2362 18.4147 16.9107 18.0892L13.2857 14.4642C12.9603 14.1388 12.9603 13.6112 13.2857 13.2857Z"
                          fill=""
                          fill-rule="evenodd"/>
                  </svg>
                </button>

                <input class="w-full bg-transparent pr-4 pl-9 focus:outline-none" placeholder="Type to search..."
                       type="text"/>
              </div>
            </form>
          </div>
            ...
            <ul class="flex items-center gap-2 2xsm:gap-4">
              <li>
                ...
                <label :class="darkMode ? 'bg-primary' : 'bg-stroke'"
                  ...
                  <input :value="darkMode" class="absolute top-0 z-50 m-0 h-full w-full cursor-pointer opacity-0" type="checkbox"
                         @click.capture="darkMode = !darkMode"/>
              ...
              <li class="relative" x-data="{ dropdownOpen: false, notifying: true }"
                ...
                <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                  ...
                  <svg class="fill-current duration-300 ease-in-out" fill="none" height="18" viewBox="0 0 18 18"
